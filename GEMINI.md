    ...
    - **Alpine.js Usage:** Use Alpine.js strictly for pure UI interactions (e.g., toggling menus, modal visibility). Data fetching and business logic must remain within HTMX/Go. Alpine.js should only handle "display control." Document the intent in comments where used.
